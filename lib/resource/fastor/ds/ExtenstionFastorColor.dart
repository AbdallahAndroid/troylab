...
extension ExtenstionFastorColor on DesignSystemFastor {
  ...
  static Future _textField_and_spiiner() async {
    ...
    DSColor.ds_textfield_hint =  ColorProject.grey; // HexColor( ColorProject.yellow_3);
    DSColor.ds_textfield_text = ColorProject.black;
    DSColor.ds_textfield_boarder_line = ColorProject.white;
    DSColor.ds_textfield_boarder_background = ColorProject.white;

    DSColor.cursor_selectedText =  ColorProject.grey ;

    //+++++++++++++++++++++++++++++ spinner

    DSColor.spinner_background  = DSColor.ds_textfield_boarder_background;
    DSColor.spinner_underline =   DSColor.ds_textfield_hint ;
    DSColor.spinner_hint =   ColorProject.grey  ;
  }
  //
  //
